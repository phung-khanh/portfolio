              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 mt-1">im.hnahk@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 mt-1">+84 879 321 400</p>
                  </div>
                </div>
            ...
            <div className="bg-gray-800 rounded-xl p-8 shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-3 px-6 text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition disabled:opacity-50"
                >
